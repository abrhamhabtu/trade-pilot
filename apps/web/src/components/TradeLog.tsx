            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-[#262420] border border-white/10 rounded-lg text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30 transition-all w-64"
                />
              </div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-[#262420] border border-white/10 rounded-lg px-4 py-2 pr-8 text-zinc-100 focus:outline-none focus:border-emerald-500/30 transition-all"
                >
              ...
              <tr className="border-b border-white/5">
                <th className="text-left p-4">
                  <input
                    ...
                    className="rounded border-white/10 bg-[#262420] text-emerald-500 focus:ring-[#30B886]"
                  />
                </th>
                <th className="text-left p-4">
                  <button
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="bg-[#262420] border border-white/10 rounded px-3 py-1 text-zinc-100 text-sm focus:outline-none focus:border-emerald-500/30"
              >
