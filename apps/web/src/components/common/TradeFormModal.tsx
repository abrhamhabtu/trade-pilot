    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/5">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-zinc-400 hover:text-zinc-100 hover:bg-[#262420] transition-colors"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg bg-[#1B1A17] border ${errors.symbol ? 'border-rose-500/30' : 'border-white/5'} text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30`}
                placeholder="AAPL"
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg bg-[#1B1A17] border ${errors.date ? 'border-rose-500/30' : 'border-white/5'} text-zinc-100 focus:outline-none focus:border-emerald-500/30`}
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-[#1B1A17] border border-white/5 text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30"
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg font-medium transition-all ${formData.side === 'Long' ? 'bg-emerald-500 text-black' : 'bg-[#1B1A17] text-zinc-400 border border-white/5 hover:border-emerald-500/30'}`}
                >
                  Long
                </button>
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg font-medium transition-all ${formData.side === 'Short' ? 'bg-rose-500 text-white' : 'bg-[#1B1A17] text-zinc-400 border border-white/5 hover:border-rose-500/30'}`}
                >
                  Short
                </button>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg bg-[#1B1A17] border ${errors.entryPrice ? 'border-rose-500/30' : 'border-white/5'} text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30`}
                placeholder="150.00"
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg bg-[#1B1A17] border ${errors.exitPrice ? 'border-rose-500/30' : 'border-white/5'} text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30`}
                placeholder="155.00"
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg bg-[#1B1A17] border ${errors.quantity ? 'border-rose-500/30' : 'border-white/5'} text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30`}
                placeholder="100"
              />
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 rounded-lg bg-[#1B1A17] border border-white/5 text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30 resize-none"
              placeholder="Trade notes..."
            />
          </div>

          {/* Calculated P&L Preview */}
          <div className="p-4 rounded-lg bg-[#1B1A17] border border-white/5">
