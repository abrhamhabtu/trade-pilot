...
function CreateSessionModal({ onClose }: { onClose: () => void }) {
    ...
    const inputCls = clsx(
        ...
        theme === 'dark'
            ? 'bg-[#262420] border-white/10 text-zinc-100 placeholder:text-zinc-600 focus:ring-emerald-500/30 focus:border-emerald-500/50'
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className={clsx(
                ...
                theme === 'dark' ? 'bg-[#201F1B] border-white/10' : 'bg-white border-gray-200'
            )}>
                {/* Header */}
                ...
                <div className="px-6 pb-6 flex space-x-3">
                    ...
                    <button
                        ...
                        className="flex-1 py-2.5 rounded-xl bg-emerald-500 text-[#1B1A17] font-semibold text-sm hover:bg-emerald-400 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                        Create Session
                    </button>
                </div>
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-white/5 flex-shrink-0">
                ...
                <div className="flex items-center gap-3">
                    {/* View toggle */}
                    <div className="flex p-1 rounded-xl gap-1 bg-[#262420]/70 border border-white/5">
                    ...
                    <button onClick={() => setShowAddTrade(true)}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 text-[#1B1A17] font-semibold text-xs hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20">
            ...
            <div className="flex items-center gap-5 px-4 py-1.5 border-b border-white/5 flex-shrink-0 bg-[#1B1A17]/60">
                {[
            ...
            {sessionView === 'log' ? (
                ...
                <div className="flex-1 overflow-auto p-6">
                    <div className={clsx('rounded-xl border overflow-hidden', theme === 'dark' ? 'border-white/5' : 'border-gray-200')}>
                        <div className={clsx('grid grid-cols-[60px,1fr,1fr,1fr,1fr,1fr,1fr,80px,40px] gap-3 px-6 py-2.5 text-xs font-semibold uppercase tracking-wider border-b',
                            theme === 'dark' ? 'bg-[#1B1A17] border-white/5 text-zinc-500' : 'bg-gray-50 border-gray-100 text-gray-400')}>
                            <span>#</span><span>Date</span><span>Side</span><span>Entry</span>
                            <span>Exit</span><span>Qty</span><span>P&L</span><span>R</span><span></span>
                        </div>
                        <div className={theme === 'dark' ? 'bg-[#1B1A17]' : 'bg-white'}>
                            {session.trades.length === 0 ? (
                                <div className="py-20 text-center">
                                    ...
                                    <button onClick={() => setShowAddTrade(true)}
                                        className="mt-4 px-5 py-2.5 rounded-xl bg-emerald-500 text-[#1B1A17] font-semibold text-sm hover:bg-emerald-400 transition-all">
                                        Log First Trade
                                    </button>
                                </div>
                            ) : (
                ...
                /* ─── Replay View ─── */
                <div className="flex-1 min-h-0 bg-[#1B1A17]">
                    <div className="grid h-full min-h-0 grid-cols-[200px,minmax(0,1fr),290px]">
                        <div className="flex min-h-0 flex-col border-r border-white/5 bg-[#201F1B]">
                            <div className="border-b border-white/5 px-3 py-2 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 rounded-lg bg-emerald-500 px-2 py-1 text-[10px] font-semibold text-[#1B1A17] transition-all hover:bg-emerald-400"
                                >
                        ...
                        <div className="flex min-h-0 flex-col">
                            ...
                            <div className="flex items-center justify-between border-b border-white/5 px-3 py-1.5 flex-shrink-0 bg-[#1B1A17]">
                                <div className="flex items-center gap-3">
                            ...
                            <div className="min-h-0 flex-1 overflow-hidden">
                                {replay.error ? (
                                    ...
                                    <div className="flex h-full items-center justify-center bg-[#1C1B17] text-sm text-zinc-500">
                            ...
                            <div className="flex items-center gap-3 border-t border-white/5 px-3 py-1.5 flex-shrink-0 bg-[#1B1A17]">
                                ...
                                <button type="button" onClick={() => replay.setIsPlaying(!replay.isPlaying)}
                                    className={clsx(
                                        ...
                                        replay.isPlaying
                                            ? 'bg-amber-500 text-[#1B1A17] hover:bg-amber-400'
                        ...
                        <div className="flex min-h-0 flex-col border-l border-white/5 bg-[#201F1B] overflow-y-auto">
                                ...
                                <div className="rounded-xl border border-white/5 bg-[#0F1728] p-3">
                                    ...
                                    <div className="mt-4 grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className="rounded-xl bg-emerald-500 px-4 py-2.5 text-sm font-semibold text-[#1B1A17] transition-all hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-40"
                                        >
                                            Buy Market
                                        </button>
                                        <button
                                            ...
                                            className="rounded-xl bg-rose-500 px-4 py-2.5 text-sm font-semibold text-[#1B1A17] transition-all hover:bg-rose-400 disabled:cursor-not-allowed disabled:opacity-40"
                                        >
                                            Sell Market
                                        </button>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
                                            ...
                                            <div className="mt-3 grid grid-cols-2 gap-3">
                                                <div className="rounded-xl bg-[#1E1D19] p-3">
        ...
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500 text-[#1B1A17] font-semibold text-sm hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20"
                >
            ...
            {mostRecent && (
                <div className="mb-6 rounded-xl bg-gradient-to-r from-emerald-500/15 to-blue-500/10 border border-emerald-500/20 p-4 flex items-center justify-between">
                    ...
                    <button onClick={() => setOpenSession(mostRecent)}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 text-[#1B1A17] font-semibold text-sm hover:bg-emerald-400 transition-all">
            ...
            <div className="flex items-center gap-4 mb-4">
                <div className={clsx('flex p-1 rounded-xl gap-1', theme === 'dark' ? 'bg-[#262420]/50' : 'bg-gray-100')}>
                ...
                <div className={clsx('flex items-center gap-2 px-3 py-2 rounded-xl border flex-1 max-w-xs',
                    theme === 'dark' ? 'bg-[#262420]/50 border-white/10' : 'bg-white border-gray-200')}>
            ...
            <div className={clsx('rounded-xl border overflow-hidden', theme === 'dark' ? 'border-white/5' : 'border-gray-200')}>
                ...
                <div className={clsx(
                    ...
                    theme === 'dark' ? 'bg-[#1B1A17] border-white/5 text-zinc-500' : 'bg-gray-50 border-gray-200 text-gray-400'
                )}>
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                {/* Trade outcomes */}
                <div className="bg-[#1B1A17] border border-white/5 rounded-xl p-5">
...
export const Backtest: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col" style={{ background: theme === 'dark' ? '#1B1A17' : '#F8FAFC' }}>
            {/* Sub-navigation */}
            <div className={clsx(
                'border-b sticky top-0 z-10',
                theme === 'dark' ? 'bg-[#201F1B] border-white/5' : 'bg-white border-gray-200'
            )}>
