...
const MOODS = [
  ...
  { value: 'neutral', label: 'Neutral', icon: Minus, color: 'text-zinc-400', bg: 'bg-[#A8A294]/20' },
        ...
        <div className="flex items-center space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg bg-[#1B1A17] border border-white/5 text-zinc-100 placeholder-[#A8A294] focus:outline-none focus:border-emerald-500/30"
            />
          </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      {isDailyNote ? (
                        <div className="p-2 rounded-lg bg-[#262420]/80">
                        ...
                        <div className="p-2 rounded-lg bg-[#A8A294]/20">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-0.5">
                          ...
                          {isDailyNote && entry.accountName && (
                            <>
                              <span className="text-[#3A362C]">•</span>
                              <span className="text-xs px-2 py-0.5 rounded-full bg-[#262420] text-zinc-400 flex items-center space-x-1">
                  ...
                  {entry.lessonsLearned && (
                    <div className="mb-4 p-3 rounded-lg bg-[#1B1A17] border border-white/5">
                  ...
                  {entry.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {entry.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="px-2 py-1 text-xs rounded-full bg-[#262420] text-zinc-400"
                        >
                          #{tag}
                        </span>
                      ))}
