  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(115deg, #142c2b 0%, #121e2a 65%)",
        }}
      >
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="mb-3 flex flex-wrap items-center gap-2">
              <span
                className={clsx(
                  ...
                  DIFF_STYLE[strategy.difficulty],
                )}
              >
                {strategy.difficulty}
              </span>
          ...
          <div className="shrink-0 rounded-2xl border border-tp-green/20 bg-tp-green/[0.06] px-6 py-4 text-center">
            ...
            <div className="mt-1 text-xl font-semibold text-tp-green">
              Read. Plan. Execute.
            </div>
            <div className="mt-1 text-xs text-zinc-400">
              {strategy.timeframe} · {strategy.marketCondition}
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6 pt-6">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <StatCard
                ...
                label="Illustrative R:R"
                value={strategy.riskReward}
              />
              <StatCard
                icon={<Clock className="h-4 w-4 text-tp-yellow" />}
                label="Timeframe"
              ...
              <StatCard
                ...
                label="Best in"
                value={strategy.marketCondition}
                small
              />
            </div>
            ...
            <Section
              title="The thesis"
              icon={<BookOpen className="h-4 w-4 text-tp-green" />}
            >
              <p className="max-w-4xl text-[15px] leading-relaxed text-zinc-300">
                {strategy.overview}
              </p>
            </Section>
            ...
            <Section
              ...
              icon={<Target className="h-4 w-4 text-tp-green" />}
            >
              <div className="space-y-5">
                {strategy.examples.map((ex, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="overflow-hidden rounded-xl border border-white/[0.06] bg-tp-base/40"
                    >
                      <div className="grid gap-0 lg:grid-cols-2">
                        <figure className="border-b border-white/[0.06] lg:border-b-0 lg:border-r">
                          ...
                          <figcaption className="px-4 py-2 text-xs text-zinc-500">
                            Conceptual illustration · not the historical trade
                            described
                          </figcaption>
                        </figure>
                        <div className="p-5">
            ...
            <p className="text-center text-xs text-zinc-500">
              Educational playbook · win rate and R:R are illustrative. Backtest
              on your own data before trading live.
            </p>
          </div>
        )}
      />
...
const StatCard: React.FC<{
  ...
  <div className="rounded-xl border border-white/[0.06] bg-tp-card p-4">
    ...
    <div
      className={clsx(
        "mt-1.5 font-bold text-zinc-100",
