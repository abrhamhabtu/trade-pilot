        ...
        <div className="p-6 border-b border-white/5">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
              <button className="p-2 text-zinc-400 hover:text-zinc-100 hover:bg-[#262420] rounded-lg transition-all">
              ...
              <div className="grid grid-cols-6 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center space-x-1 mb-2">
                    ...
                    <div className="w-3 h-3 rounded-full bg-[#262420] flex items-center justify-center cursor-help">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="w-4 h-4 rounded-full bg-[#262420] flex items-center justify-center cursor-help">
                      <span className="text-zinc-400 text-xs">?</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={playbookData.cumulativePL} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                      ...
                      <RechartsTooltip
                        contentStyle={{
                          background: 'linear-gradient(135deg, #201F1B 0%, #262420 100%)',
                          border: '1px solid #30B886',
                          borderRadius: '8px',
