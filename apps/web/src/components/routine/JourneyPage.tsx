...
const PACE_CONFIG = {
  conservative: { label: 'Conservative', dailyTarget: 150, color: '#30B886', icon: Shield },
  moderate: { label: 'Moderate', dailyTarget: 300, color: '#6E9BD1', icon: Zap },
  aggressive: { label: 'Aggressive', dailyTarget: 600, color: '#E5564F', icon: Flame }
};
...
export const JourneyPage: React.FC = () => {
  ...
  if (!account) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center px-4">
        <div className="w-16 h-16 rounded-2xl bg-[#262420] flex items-center justify-center mb-4">
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <div className="relative p-6 rounded-[2rem] overflow-hidden border border-white/5 bg-gradient-to-br from-[#201F1B] to-[#201F1B] shadow-xl">
        <div className={clsx(
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="flex items-center space-x-6 text-white">
              ...
              <div className="w-px h-8 bg-[#262420]" />
              <div>
                ...
                <div className="relative group flex items-center">
                  ...
                  <input
                    ...
                    className="w-32 bg-transparent text-2xl font-black text-emerald-500 tabular-nums focus:outline-none placeholder-[#30B886]/50"
                  />
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-[#1B1A17] p-1.5 rounded-2xl border border-white/5">
                <button
                  onClick={() => {
                    setIsFunded(false);
      ...
      <div className={clsx(
        ...
        theme === 'dark' ? "bg-[#1B1A17] border-white/5" : "bg-gray-100 border-gray-200"
      )}>
        <button
          ...
          className={clsx(
            ...
            activeTab === 'overview'
              ? (theme === 'dark' ? "bg-[#262420] text-white shadow-lg" : "bg-white text-gray-900 shadow-sm")
      ...
      {activeTab === 'overview' ? (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6 bg-[#201F1B]/60 p-8 rounded-[2.5rem] border border-white/5/50 backdrop-blur-xl shadow-2xl">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 p-3 flex flex-col justify-between z-10">
                      <div className="flex justify-between items-start">
                        ...
                        {day.isToday && (
                          <div className="w-1 h-1 rounded-full bg-zinc-200 shadow-[0_0_10px_#6E9BD1]" />
                        )}
                      </div>
                            ...
                            <div className="space-y-1">
                              ...
                              {day.isProjected && !day.isGoalDay && day.pnl !== 0 && (
                                <div className="h-0.5 w-full bg-white/5 rounded-full overflow-hidden">
                                  <div className="h-full bg-[#262420]/80 w-full" />
                                </div>
                              )}
                            </div>
                          )}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="p-6 rounded-[2.5rem] bg-[#1B1A17]/80 backdrop-blur-md border border-white/5 shadow-xl relative overflow-hidden group">
              ...
              {/* FOCUS TASKS WIDGET */}
              <div className="p-6 rounded-[2.5rem] bg-[#201F1B] border border-white/5 shadow-xl relative overflow-hidden group">
              ...
              <div className={clsx(
                ...
                theme === 'dark' ? "bg-[#1B1A17]/80 backdrop-blur-md border-white/5" : "bg-[#F8F9FB] border-gray-100"
              )}>
                ...
                {lastPayoutDate && (
                  <div className={clsx(
                    ...
                    theme === 'dark' ? "bg-[#262420] text-zinc-400" : "bg-purple-50 text-purple-600"
                  )}>
                ...
                <div className={clsx(
                  ...
                  <div className="space-y-1.5">
                    ...
                    {/* Progress bar */}
                    <div className="h-1.5 w-full bg-[#262420] rounded-full overflow-hidden mt-1">
                      <div
                        className={clsx(
                      ...
                      <button
                        ...
                        className={clsx(
                          ...
                          consistencyRule === rule
                            ? (theme === 'dark' ? "bg-[#262420] text-white shadow-lg" : "bg-white text-gray-900 shadow-sm border border-gray-100")
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-[2.5rem] bg-[#1B1A17]/80 backdrop-blur-md border border-white/5 shadow-xl">
            ...
            <div className="p-8 rounded-[2.5rem] bg-gradient-to-br from-[#201F1B] to-[#262420] border border-white/5 shadow-xl flex items-center justify-between">
              <div className="space-y-4">
