...
const TIER_CONFIG = {
  instant: { label: 'Instant Funded', defaultRule: 20, color: '#30B886' },
  elite: { label: 'Elite Funded', defaultRule: 25, color: '#6E9BD1' }
};
...
export const ConsistencyGuardian: React.FC<ConsistencyGuardianProps> = ({
  ...
  const gaugeColor = gaugePercent <= 70 ? '#30B886' : gaugePercent <= 90 ? '#F59E0B' : '#E5564F';
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={clsx(
                  "w-full pl-10 pr-4 py-3 rounded-xl text-lg font-bold focus:outline-none focus:ring-2 focus:ring-[#30B886]/50",
                  theme === 'dark'
                    ? "bg-[#262420] text-white border border-white/10"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="relative w-48 h-28">
                  <svg className="w-48 h-28" viewBox="0 0 100 60">
                    ...
                    <path
                      ...
                      fill="none"
                      stroke={theme === 'dark' ? '#3A362C' : '#EDEAE3'}
                      strokeWidth="8"
                      strokeLinecap="round"
                    />
                    {/* Progress arc */}
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className={clsx(
            ...
            theme === 'dark'
              ? "bg-gradient-to-br from-[#201F1B] to-[#201F1B] border-white/5"
          ...
          <div className={clsx(
            ...
            <div className="mb-4">
              <div className={clsx(
                ...
                theme === 'dark' ? "bg-zinc-200/5 border border-[#6E9BD1]/10" : "bg-purple-50 border border-purple-100"
              )}>
              ...
              <div className="flex items-center gap-4">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className={clsx(
                      "w-full pl-10 pr-4 py-3.5 rounded-xl text-lg font-bold focus:outline-none focus:ring-2 focus:ring-[#6E9BD1]/50 transition-all",
                      theme === 'dark'
                        ? "bg-[#1B1A17] text-white border border-[#6E9BD1]/20 placeholder-[#4B5563]"
                ...
                <input
                  ...
                  className="flex-1 h-2 bg-[#262420] rounded-lg appearance-none cursor-pointer accent-[#6E9BD1]"
                />
              </div>
            </div>
      ...
      <div className={clsx(
        ...
        <button
          ...
          className={clsx(
            ...
            theme === 'dark' ? "hover:bg-[#262420]/50" : "hover:bg-gray-50"
          )}
        >
          ...
          <div className={clsx(
            ...
            <div>
              ...
              <div className={clsx(
                ...
                theme === 'dark' ? "bg-[#1B1A17]" : "bg-gray-100"
              )}>
