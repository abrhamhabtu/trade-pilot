...
const RULE_CATEGORIES: Record<TradingRule['category'], { label: string; color: string; icon: React.ElementType }> = {
  entry: { label: 'Entry', color: '#30B886', icon: LogIn },
  exit: { label: 'Exit', color: '#6E9BD1', icon: LogOut },
  risk: { label: 'Risk', color: '#E5564F', icon: Shield },
  mindset: { label: 'Mindset', color: '#6E9BD1', icon: Brain },
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className={clsx(
        ...
        <button
          ...
          className={clsx(
            ...
            theme === 'dark'
              ? 'hover:bg-[#262420] text-zinc-400 hover:text-zinc-100'
        ...
        <div className={clsx(
          ...
          <div className="flex space-x-2">
            <input
              ...
              className={clsx(
                'flex-1 px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#30B886]/50',
                theme === 'dark'
            ...
            <button
              ...
              className="px-3 py-2 bg-emerald-500 text-black rounded-lg hover:bg-emerald-500/90 transition-colors"
            >
        ...
        <div className={clsx(
          ...
          <div className="mb-6">
            ...
            <div className="flex space-x-2">
              {[
                ...
                { value: 'neutral', icon: Minus, color: 'text-zinc-400', bg: 'bg-[#A8A294]' },
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    gamePlan.marketBias === value
                      ...
                      : theme === 'dark'
                        ? 'bg-[#1B1A17] border-white/5 text-zinc-400 hover:border-emerald-500/30'
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Support */}
              <div>
                <p className="text-xs text-emerald-500 mb-2 font-medium">Support</p>
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className={clsx(
                        'flex-1 px-2 py-1 rounded border text-sm focus:outline-none focus:ring-1 focus:ring-[#30B886]/50',
                        theme === 'dark'
                          ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                          : 'bg-gray-50 border-gray-300 text-gray-900'
                      )}
                    />
                    <button onClick={handleAddSupport} className="text-emerald-500">
                      <Plus className="h-4 w-4" />
                    </button>
                  </div>
                </div>
              ...
              {/* Resistance */}
              <div>
                <p className="text-xs text-rose-500 mb-2 font-medium">Resistance</p>
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    />
                    <button onClick={handleAddResistance} className="text-rose-500">
                      <Plus className="h-4 w-4" />
                    </button>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className={clsx(
                  'flex-1 px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#6E9BD1]/50',
                  theme === 'dark'
                    ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                    : 'bg-gray-50 border-gray-300 text-gray-900'
                )}
              ...
              <button
                ...
                className="px-3 py-2 bg-zinc-200 text-white rounded-lg hover:bg-zinc-200/90 transition-colors"
              >
                <Plus className="h-4 w-4" />
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <p className="text-xs text-zinc-400 mb-1">Max Loss</p>
                <input
                  type="number"
                  ...
                  placeholder="$0"
                  className={clsx(
                    'w-full px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#E5564F]/50',
                    theme === 'dark'
                      ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                      : 'bg-gray-50 border-gray-300 text-gray-900'
                  )}
              ...
              <div>
                <p className="text-xs text-zinc-400 mb-1">Max Profit</p>
                <input
                  type="number"
                  ...
                  placeholder="$0"
                  className={clsx(
                    'w-full px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#30B886]/50',
                    theme === 'dark'
                      ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                      : 'bg-gray-50 border-gray-300 text-gray-900'
                  )}
              ...
              <div>
                <p className="text-xs text-zinc-400 mb-1">Max Trades</p>
                <input
                  type="number"
                  ...
                  placeholder="0"
                  className={clsx(
                    'w-full px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#6E9BD1]/50',
                    theme === 'dark'
                      ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                      : 'bg-gray-50 border-gray-300 text-gray-900'
                  )}
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className={clsx(
                'w-full px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#30B886]/50 resize-none',
                theme === 'dark'
                  ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                  : 'bg-gray-50 border-gray-300 text-gray-900'
              )}
      ...
      <div className={clsx(
              ...
              <button
                ...
                className={clsx(
                  ...
                  gamePlan.ruleCompliance?.length === 0
                    ...
                    : theme === 'dark'
                      ? 'bg-[#262420] text-zinc-100 hover:bg-[#322F28]'
        ...
        {tradingRules.length > 0 && (
          <div className={clsx(
            'mb-4 p-3 rounded-lg border',
            theme === 'dark' 
              ? 'bg-[#6E9BD1]/10 border-[#6E9BD1]/30' 
              : 'bg-blue-50 border-blue-200'
          )}>
            <p className={clsx('text-xs', theme === 'dark' ? 'text-zinc-400' : 'text-gray-600')}>
              <strong className={theme === 'dark' ? 'text-zinc-100' : 'text-gray-700'}>How it works:</strong> Your rules are saved automatically and apply to all trading days. 
            ...
            <p className={clsx(
                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        ...
                        theme === 'dark' ? 'ring-offset-[#1B1A17]' : 'ring-offset-gray-50'
                      )}
                      style={{ 
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  className={clsx(
                    'flex-1 px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#E5564F]/50',
                    theme === 'dark'
                      ? 'bg-[#1B1A17]/80 backdrop-blur-md border-white/5 text-zinc-100 placeholder-[#A8A294]'
                      : 'bg-white border-gray-300 text-gray-900'
                  )}
                />
                <button
                  onClick={handleAddRule}
                  className="px-4 py-2 bg-rose-500 text-white rounded-lg hover:bg-rose-500/90 transition-colors font-medium text-sm"
                >
                  Save Rule
                </button>
              </div>
        ...
        {tradingRules.length === 0 ? (
          <div className={clsx(
            ...
            <p className={clsx('text-xs', theme === 'dark' ? 'text-zinc-400' : 'text-gray-400')}>
                          ...
                          >
                            <div className="flex items-center space-x-3 flex-1">
                              <button
                                ...
                                className={clsx(
                                  'p-1 rounded',
                                  rule.isActive ? 'text-emerald-500' : 'text-zinc-400'
                                )}
                                ...
                                <button
                                  ...
                                  className={clsx(
                                    ...
                                    compliance === true
                                      ...
                                      : theme === 'dark'
                                        ? 'bg-[#262420] text-zinc-400 hover:text-emerald-500'
                                ...
                                <button
                                  ...
                                  className={clsx(
                                    ...
                                    compliance === false
                                      ...
                                      : theme === 'dark'
                                        ? 'bg-[#262420] text-zinc-400 hover:text-rose-500'
      ...
      <div className={clsx(
        ...
        <div className="flex items-center space-x-3 mb-6">
          <div className="p-2 rounded-lg bg-[#6E9BD1]/10">
            <BookOpen className="h-5 w-5 text-[#6E9BD1]" />
          </div>
          <div>
            <h2 className={clsx(
              'text-lg font-semibold',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <button
                ...
                className={clsx(
                  ...
                  gamePlan.followedPlan === true
                    ...
                    : theme === 'dark'
                      ? 'bg-[#1B1A17] border-white/5 text-zinc-400 hover:border-emerald-500/50'
              ...
              <button
                ...
                className={clsx(
                  ...
                  gamePlan.followedPlan === false
                    ...
                    : theme === 'dark'
                      ? 'bg-[#1B1A17] border-white/5 text-zinc-400 hover:border-rose-500/50'
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                { value: 'calm', label: 'Calm', color: '#30B886' },
                { value: 'confident', label: 'Confident', color: '#6E9BD1' },
                { value: 'neutral', label: 'Neutral', color: '#A8A294' },
                { value: 'anxious', label: 'Anxious', color: '#FBBF24' },
                { value: 'frustrated', label: 'Frustrated', color: '#E5564F' },
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    gamePlan.emotionalState === value
                      ? 'ring-2 ring-offset-1'
                      : 'opacity-60 hover:opacity-100',
                    theme === 'dark' ? 'ring-offset-[#201F1B]' : 'ring-offset-white'
                  )}
                  style={{
                    backgroundColor: `${color}20`,
                    color: color,
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            rows={3}
            className={clsx(
              'w-full px-3 py-2 rounded-lg border text-sm focus:outline-none focus:ring-2 focus:ring-[#6E9BD1]/50 resize-none',
              theme === 'dark'
                ? 'bg-[#1B1A17] border-white/5 text-zinc-100 placeholder-[#A8A294]'
                : 'bg-gray-50 border-gray-300 text-gray-900'
            )}
        ...
        {gamePlan.ruleCompliance && gamePlan.ruleCompliance.length > 0 && (
          <div className={clsx(
            'mt-6 p-4 rounded-lg',
            theme === 'dark' ? 'bg-[#1B1A17]' : 'bg-gray-50'
          )}>
            <p className={clsx(
              'text-sm font-medium mb-3',
              theme === 'dark' ? 'text-zinc-100' : 'text-gray-700'
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 rounded-full bg-[#A8A294]" />
                <span className={clsx('text-sm', theme === 'dark' ? 'text-zinc-400' : 'text-gray-600')}>
